...
- [x] 로또 구입 금액에 공백이 입력되었을 때
- [x] 당첨 번호의 개수가 다르게 입력되었을 때
- [x] 당첨 번호와 보너스 번호에 범위를 벗어나는 숫자(or 소수)가 입력되었을 때
- [x] 당첨 번호와 보너스 번호에 숫자가 아닌 문자가 입력되었을 때
- [x] 보너스 번호가 로또 당첨 번호와 중복으로 입력되었을 때

---

## 전제 조건

- 로또 최대 구입 금액은 100억원이다
